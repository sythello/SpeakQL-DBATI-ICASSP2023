...
@DatasetReader.register('spider_ASR_rewriter_reader_seq2seq_tabert')
class SpiderASRRewriterReader_Seq2seq_TaBERT(DatasetReader):
    '''
    Seq2seq baseline, with copy mechanism, TaBERT embedder
    '''
    def __init__(self,
...
if __name__ == '__main__':
    ...
    #     schemas_json_path = '/Users/mac/Desktop/syt/Deep-Learning/Dataset/spider/tables.json'
    # )

    # for table_name, table in tables.items():
    #     print(table_name, table)
    #     print('\t'.join([str(c) for c in table.header]))
    ...
    prototype_dict_path = dataset_dir + "/db/prototypes/prototypes_dict.pkl"
    ...
    # print(len(train_dataset_s2s), len(dev_dataset_s2s))
    print(list(train_dataset_s2s[0].fields['sentence']))
    print(train_dataset_s2s[0].fields['schema_column_ids'].array)
    print(train_dataset_s2s[0].fields['metadata'].metadata)
    print(train_dataset_s2s[0].fields['metadata']['tabert_tables'])
