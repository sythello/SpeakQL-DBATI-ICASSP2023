# (2.33.6) Base 2.33.5 (-align_tags); -audio_feats
...

{
  ...
  "model": {
    ...
    "using_phoneme_multilabels": false, # phoneme multi-label loss is on audio, so when no audio shouldn't set 
    ...
    "encoder": {
      ...
      "seq2seq_encoders": [
        {
          "type": "lstm",
          "input_size": (SRC_EMB_DIM + TAG_EMB_DIM * 2 + CHAR_EMB_DIM),
