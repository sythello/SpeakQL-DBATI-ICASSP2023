...
@DatasetReader.register('spider_ASR_rewriter_reader_seq2seq_comb')
class SpiderASRRewriterReader_Seq2seq_Combined(DatasetReader):
    '''
    ...
    def _read(self, file_path: str) -> Iterator[Instance]:
        ...
        for i, cand_list in enumerate(dataset_json):
            ...
            if self.use_tabert:
                # Using tabert, building tabert_tables
