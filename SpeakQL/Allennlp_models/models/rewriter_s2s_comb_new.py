...
@Model.register('spider_ASR_rewriter_seq2seq_comb_new')
class SpiderASRRewriter_Seq2seq_Combined_new(SpiderASRFixer_Base):
    def __init__(self,
                 ...
                 rewrite_decoder: SeqDecoder = None,    ## Must be a CopyNetSeqDecoder
    ...
    def forward(self,
                ...
                # END general
                rewrite_seq_s2s: Dict[str, torch.Tensor] = None,
        ...
        decoder_out = self.rewrite_decoder.forward(
        ...
        # print(f"--- CP 4: decoder_out['loss'] = {decoder_out['loss'].item()}")
        ...
        if 'predictions' in decoder_out:
            # Eval 
            # output['rewrite_seq_LLs'] = decoder_out['class_log_probabilities']
    ...
    def make_output_human_readable(self, output_dict: Dict[str, torch.Tensor]) -> Dict[str, torch.Tensor]:
        ...
        if 'rewrite_seq_preds' in output_dict:
            ...
            # Need this special function to postprocess copy tokens
