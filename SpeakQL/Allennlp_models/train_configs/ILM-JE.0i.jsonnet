# (2.35.1) Base 2.31.0: full ablation (-all)
# (-all tags, -char_emb, -full DB, -phonemes (-aux_ph_loss, -ph_attention), -audio_feats; only keeping rewriter tags)
# Fix 2.35.0 error
  ...
  "model": {
    ...
    "encoder": {
      ...
      "seq2seq_encoders": [
        {
          "type": "lstm",
          "input_size": (SRC_EMB_DIM + TAG_EMB_DIM),
