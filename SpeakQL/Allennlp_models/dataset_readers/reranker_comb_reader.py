...
@DatasetReader.register('spider_ASR_reranker_reader_v2_siamese_comb')
class SpiderASRRerankerReaderV2_Siamese_Combined(DatasetReader):
    '''
    ...
    def __init__(self,
                 ...
                 audio_feats_type: str = 'mfcc',    # ['mfcc', 'wav2vec', 'raw']; Not tested yet for reranker
