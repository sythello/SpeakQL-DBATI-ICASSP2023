...
@DatasetReader.register('spider_ASR_rewriter_reader_ILM_comb')
class SpiderASRRewriterReader_ILM_Combined(DatasetReader):
    '''
    ...
    def text_to_instance(self,
        ...
        if rewriter_tags is not None:
            rewriter_tag_tokens_padded = rewriter_tags + ['O' for _ in range(len(concat_tokens) - len(text_tokens))]            
