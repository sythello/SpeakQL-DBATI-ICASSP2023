...
@TokenEmbedder.register("pretrained_transformer_mismatched_patched")
class PretrainedTransformerMismatchedEmbedder_Patched(TokenEmbedder):
    """
    ...
    @YS: added argument "sub_module", "scalar_mix_size", "set_output_hidden_states", "hidden_states_return_idx"
        > check pretrained_transformer_patched for details of new args
    ...
    def __init__(
        ...
        self._matched_embedder = PretrainedTransformerEmbedder_Patched(
            model_name,
            ...
            scalar_mix_size=scalar_mix_size,
            set_output_hidden_states=set_output_hidden_states,
            hidden_states_return_idx=hidden_states_return_idx,
        )
