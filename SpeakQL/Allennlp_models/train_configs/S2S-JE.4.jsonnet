...
# (Base 3.14) "clean" setting: -all tags, -char_emb, -DB tokens, -phonemes (-aux_ph_loss, -ph_attention), -audio_feats
# target lowercasing
...

{
  "dataset_reader": {
    ...
    "use_phoneme_labels": false,   # either single or multi-label
