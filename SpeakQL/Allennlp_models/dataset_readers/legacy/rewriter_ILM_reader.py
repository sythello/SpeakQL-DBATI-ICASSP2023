...
@DatasetReader.register('spider_ASR_rewriter_reader_ILM')
class SpiderASRRewriterReader_ILM(DatasetReader):
    '''
    ...
    def text_to_instance(self,
        ...
        if rewrite_tokens is not None:
            ...
            metadata["rewrite_seq"] = [t.text for t in rewrite_tokens[1:-1]]
    ...
    def _read(self, file_path: str) -> Iterator[Instance]:
        ...
        if self.debug:
            dataset_json = dataset_json[:10] + dataset_json[10::200]
        ...
        for i, cand_list in enumerate(dataset_json):
            ...
            for cand in cand_list:
                ...
                if self.use_tagger_prediction:
                    tags = cand['tagger_predicted_rewriter_tags']
                else:
