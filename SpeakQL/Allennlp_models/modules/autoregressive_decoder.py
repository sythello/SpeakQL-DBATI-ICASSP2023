...
@SeqDecoder.register("speakql_auto_regressive_seq_decoder")
class SpeakQLAutoRegressiveSeqDecoder(SeqDecoder):
    """
    ...
    def __init__(
        ...
        # YS: more metrics
        self._training_token_accuracy = CategoricalAccuracy(top_k=1, tie_break=False)
    ...
    def _forward_loss(
        ...
        # YS: add a loss to better keep track of training progress
        self._training_token_accuracy(logits, targets[:, 1:].contiguous(), target_mask[:, 1:].contiguous())
    ...
    def get_metrics(self, reset: bool = False) -> Dict[str, float]:
        ...
        if not self.training:
            ...
            # YS: add training metrics (what was this for...? I forgot)
            all_metrics['token_acc'] = self._training_token_accuracy.get_metric(reset=reset)
