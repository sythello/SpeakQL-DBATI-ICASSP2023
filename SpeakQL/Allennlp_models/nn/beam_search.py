...
# @YS: changed the return value, to include the state for each candidate in final beam
...
class BeamSearch:
    ...
    def _reconstruct_sequences(predictions, backpointers):
        ...
        # @YS: in the reversed order of timesteps
        # @YS TODO: allowing higher dim predictions, i.e. attention & selection vector per step
