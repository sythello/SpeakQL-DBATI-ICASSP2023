...
def Full_evaluate_S2S(eval_version,
                      rewriter_s2s_pred_path,
                      test_dataset_path,
                      orig_dev_path,
                      model_dict,
                      pred_key="s2s_prediction",
    ...
    Example paths:
    rewriter_s2s_pred_path = '/Users/mac/Desktop/syt/Deep-Learning/Projects-M/SpeakQL/SpeakQL/Allennlp_models/outputs/output-{}.json'.format(VERSION)
    ...
    for d in tqdm(test_dataset):
        ...
        _rewritten_question = ' '.join(p[pred_key])
        ...
        # For BLEU 
        _rewritten_question_toks = [_t.lower() for _t in p[pred_key]]
...
def main(args):
    ...
    Full_evaluate_S2S(eval_version=args.eval_version,
                      rewriter_s2s_pred_path=args.rewriter_s2s_pred_path,
...
if __name__ == '__main__':
    ...
    parser.add_argument('-pred', '--rewriter_s2s_pred_path', type=str, required=True)
    ...
    parser.add_argument('-pred_key', '--pred_key', type=str, default="s2s_prediction")
